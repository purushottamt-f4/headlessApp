...
router.post('/postUrl',async(req , resp)=>{
    try {
    const validationResult = await shortUrlPostrequestBodySchema.safeParseAsync(req.body);
...
router.get('/:shortenUrl',async(req , resp)=>{
    try {
